...
class SmallInfCell: UICollectionViewCell {
    ...
    private func setup() {
        ...
        header.topAnchor.constraint(equalTo: iv.topAnchor, constant: 4).isActive = true
        
        addSubview(countOfWords)
        countOfWords.leadingAnchor.constraint(equalTo: header.leadingAnchor).isActive = true
        countOfWords.topAnchor.constraint(equalTo: header.bottomAnchor, constant: 0).isActive = true
